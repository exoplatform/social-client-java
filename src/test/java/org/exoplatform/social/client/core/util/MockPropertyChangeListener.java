...
/**
 * Making the Mock object which provide to make the UnitTestCase for
...
public class MockPropertyChangeListener implements PropertyChangeListener {
  ...
  /**
   * Retrieves the newValue of the property which will be assigned to the
   * property specified by property name.
   * 
