...
public interface ActivityService<Activity> extends Service<Activity> {
   ...
   * </pre>
   * 
   * @param ownerStreamRestIdentity the owner stream identity, could be a user
   *          or space identity.
   ...
   * @since 1.0.0-alpha2
   */
  RealtimeListAccess<RestActivity> getActivityStream(RestIdentity restIdentity, QueryParams queryParams) throws SocialClientLibException;
   ...
   * @since 1.0.0-alpha2
   */
  RealtimeListAccess<RestActivity> getSpacesActivityStream(RestIdentity restIdentity, QueryParams queryParams) throws SocialClientLibException;
   ...
   * @since 1.0.0-alpha2
   */
  RealtimeListAccess<RestActivity> getConnectionsActivityStream(RestIdentity restIdentity, QueryParams queryParams) throws SocialClientLibException;
   ...
   * @since 1.0.0-alpha2
   */
  RealtimeListAccess<RestActivity> getFeedActivityStream(RestIdentity restIdentity, QueryParams queryParams) throws SocialClientLibException;
   ...
   * @param existingActivity the existing activity
   * @return the created
   *         {@link org.exoplatform.social.client.api.model.RestLike} instance
   * @throws AccessDeniedException
   * @throws ServiceException
   */
