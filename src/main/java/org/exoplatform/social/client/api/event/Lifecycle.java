...
/**
 * Common interface for component life cycle methods. In order to provide a
 * consistent to start and stop the component.
 * 
 * @author thanh_vucong
 */
public interface Lifecycle<M, S> {
   ...
   * component. This method should be called before any of the public methods of
   * this component are utilized. It should also send a LifecycleEvent of type
   * START_EVENT to any registered listeners.
   * 
   ...
   * component. This method should be the last one called on a given instance of
   * this component. It should also send a LifecycleEvent of type STOP_EVENT to
