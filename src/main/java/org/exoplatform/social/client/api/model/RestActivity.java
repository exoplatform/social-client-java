...
public class RestActivity extends Model {
  ...
  /**
   * Gets a string specifying the primary text of an activity. Container support
   * for this field is REQUIRED. Titles may only have the following HTML tags:
   * &lt;b&gt; &lt;i&gt;, &lt;a&gt;, &lt;span&gt;. The container may ignore this
   * formatting when rendering the activity.
   * 
  ...
  /**
   * Sets a string specifying the primary text of an activity. Container support
   * for this field is REQUIRED. Titles may only have the following HTML tags:
   * &lt;b&gt; &lt;i&gt;, &lt;a&gt;, &lt;span&gt;. The container may ignore this
   * formatting when rendering the activity.
   * 
   ...
   * Container support for this field is REQUIRED. The title is the primary text
   * of an activity. Titles may only have the following HTML tags: <&lt;b&gt;
   * &lt;i&gt;, &lt;a&gt;, &lt;span&gt;. The container may ignore this
   * formatting when rendering the activity.
   * 
  ...
  /**
   * Set a map of custom key/value pairs associated with this activity. The data
   * has type {@link Map<String, Object>}. The object may be either a String or
   ...
   * Container support for this field is OPTIONAL.
   * 
   * @param templateParams a map of custom key/value pairs associated with this
   *          activity.
   */
  ...
  /**
   * Gets the available list of likes for this activity. Return Number of latest
   * likes of this activity.
   * 
  ...
  public List<RestComment> getTotalComments() throws SocialClientLibException {
    final String GET_ACTIVITY_REQUEST_URL = SocialHttpClientSupport.buildCommonRestPathFromContext(true) + "activity/"
        + this.getId() + "/comments.json";
  ...
  public RestActivityStream getActivityStream() throws SocialClientLibException {
    ...
    try {
      ...
      if (activityStreamJSON != null && activityStreamJSON.length() > 2) {
        ...
        final String GET_ACTIVITY_REQUEST_URL = SocialHttpClientSupport.buildCommonRestPathFromContext(true) + "activity/"
            + this.getId() + ".json?" + queryParamBuilder.buildQuery();
        HttpResponse response = SocialHttpClientSupport.executeGet(GET_ACTIVITY_REQUEST_URL, POLICY.BASIC_AUTH);
        handleError(response);
  ...
  /**
   * Adds a new template parameter with the specified name and value. This is a
   * helper method.
   * 
