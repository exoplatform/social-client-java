 ...
 * http://www.
 * opensocial.org/Technical-Resources/opensocial-spec-v081/opensocial-
 * reference#opensocial.Activity and
 * <tt>org.exoplatform.social.core.activity.model.ExoSocialActivity</tt> class
 * on eXo Social project.
 * 
...
public class RestActivity extends Model {
    ...
    /**
     * Gets a string specifying the primary text of an activity. Container
     * support for this field is REQUIRED. Titles may only have the following
     * HTML tags: &lt;b&gt; &lt;i&gt;, &lt;a&gt;, &lt;span&gt;. The container
     * may ignore this formatting when rendering the activity.
     * 
    ...
    /**
     * Sets a string specifying the primary text of an activity. Container
     * support for this field is REQUIRED. Titles may only have the following
     * HTML tags: &lt;b&gt; &lt;i&gt;, &lt;a&gt;, &lt;span&gt;. The container
     * may ignore this formatting when rendering the activity.
     * 
    ...
    /**
     * Gets a string specifying the title template message ID in the gadget
     * spec. Container support for this field is REQUIRED. The title is the
     * primary text of an activity. Titles may only have the following HTML
     * tags: <&lt;b&gt; &lt;i&gt;, &lt;a&gt;, &lt;span&gt;. The container may
    ...
    /**
     * Sets the body fields of Activity, this field is optional and use to
     * storage the extended attribute of activity.
     * 
     * @param body
     */
    ...
    /**
     * gets the body fields of Activity, this field is optional and use to
     * storage the extended attribute of activity.
     * 
     * @return
     */
    ...
    /**
     * Sets a string specifying the title template message ID in the gadget
     * spec. Container support for this field is REQUIRED. The title is the
     * primary text of an activity. Titles may only have the following HTML
     * tags: <&lt;b&gt; &lt;i&gt;, &lt;a&gt;, &lt;span&gt;. The container may
     * ignore this formatting when rendering the activity.
     ...
     * with. Container support for this field is REQUIRED.
     * 
    ...
    /**
     * Gets a string specifying the type of activity. Container support for this
     * field is REQUIRED.
     * 
     * @return A string specifying the application that this activity is
     *         associated with
    ...
    /**
     * Sets a string specifying the type of activity. Container support for this
     * field is REQUIRED.
     * 
     * @param appId A string specifying the application that this activity is
     *            associated with
     ...
     * epoch. Container support for this field is OPTIONAL. Higher priority ones
     ...
     * are higher in the list.
     * 
     * @return The last updated time at which this activity took place in
     ...
     * epoch Container support for this field is OPTIONAL. This value can not be
     * set by the end user.
     * 
     ...
     * milliseconds since the epoch Container support for this field is
     * OPTIONAL. This value can not be set by the end user.
     * 
     * @param lastUpdated the time at which this activity took place in
     *            milliseconds since the epoch
     */
     ...
     * source. Container support for this field is OPTIONAL.
     * 
     * @return a number between 0 and 1 representing the relative priority of
     *         this activity in relation to other activities from the same
     *         source
     */
     ...
     *            priority of this activity in relation to other activities from
     *            the same source.
     */
     ...
     * data has type {@link Map<String, Object>}. The object may be either a
     * String or a Person. When passing in a person with key PersonKey, can use
     * the following replacement variables in the template:
     * <ul>
    ...
    public RestIdentity getPosterIdentity() throws SocialClientLibException {
        ...
        if (posterIdentityString != null && posterIdentityString.length() > 2) {
            try {
                restIdentity = SocialJSONDecodingSupport.parser(RestIdentity.class,
                                                                posterIdentityString);
            } catch (Exception e) {
                throw new ServiceException(ActivityService.class, e.getMessage(), e);
            }
        } else {
            IdentityService service = ClientServiceFactoryHelper.getClientServiceFactory()
    ...
    /**
     * Gets the available list of comments for this activity. Return Number of
     * latest comments of this activity.
     * 
    ...
    public List<RestComment> getAvailableComments() {
        try {
            ...
            List<? extends RestComment> comments = SocialJSONDecodingSupport.JSONArrayObjectParser(RestComment.class,
                                                                                                   commentsJSON);
    ...
    /**
     * Gets the available list of likes for this activity. Return Number of
     * latest likes of this activity.
     * 
    ...
    public List<RestIdentity> getAvailableLikes() {
        try {
            ...
            List<? extends RestIdentity> likedByIdentities = SocialJSONDecodingSupport.JSONArrayObjectParser(RestIdentity.class,
                                                                                                             likedByIdentitiesJSON);
    ...
    public List<RestComment> getTotalComments() throws SocialClientLibException {
        final String GET_ACTIVITY_REQUEST_URL = SocialHttpClientSupport.buildCommonRestPathFromContext(true)
                + "activity/" + this.getId() + "/comments.json";
    ...
    public RestActivityStream getActivityStream() throws SocialClientLibException {
        ...
        try {
            ...
            if (activityStreamJSON != null && activityStreamJSON.length() > 2) {
                restActivityStream = SocialJSONDecodingSupport.parser(RestActivityStream.class,
                                                                      activityStreamJSON);
            } else {
                ...
                HttpResponse response = SocialHttpClientSupport.executeGet(GET_ACTIVITY_REQUEST_URL,
                                                                           POLICY.BASIC_AUTH);
                handleError(response);
                RestActivity activity = SocialJSONDecodingSupport.parser(RestActivity.class,
                                                                         response);
    ...
    /**
     * Returns the template parameter with the specified name. This is a helper
     * method.
     * 
    ...
    /**
     * Adds a new template parameter with the specified name and value. This is
     * a helper method.
     * 
